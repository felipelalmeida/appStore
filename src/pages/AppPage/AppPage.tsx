import { IonContent, IonPage, useIonViewWillEnter, IonGrid, IonRow, IonCol, IonItem, IonLabel, IonList } from "@ionic/react";
                    ...
                    <div className="page-content">
                        ...
                        <div className="main-content">
                            <div className="main-description">
                                <p className="app-description app-description1">Explore mundos infinitos e construa de tudo, desde as casas mais simples até os mais grandiosos castelos. Jogue com recursos ilimitados no modo criativo ou minere as profundezas do mundo no modo de sobrevivência, criando armas e armaduras para se defender de criaturas perigosas.</p>
                                <p className={`app-description app-description2 ${!isDescriptionVisible ? 'hidden' : ''}`}>Minecraft agora vem com a opção de comprar Minecraft Realms. Realms é um serviço de assinatura mensal que permite a criação de um mundo sempre online no Minecraft. Atualmente há duas opções de assinatura para escolha, dependendo de quantas pessoas você deseja convidar para jogar simultaneamente no seu realm. Um Realm para você e mais 2 amigos custa 3.99 dólares/mês (ou equivalente local) e um Realm para você e mais 10 amigos custa 7.99 dólares/mês (ou equivalente local).</p>
                                <p className="read-more" onClick={toggleDescription}>{isDescriptionVisible ? 'ler menos' : 'ler mais'}</p>
                            </div>
                        </div>
                        ...
                        >
                            <SwiperSlide className="img-swiper-slide">
                                <div className="rating-box">
                                    <h3 className="review-user-title">
                                        Bem massa!
                                    </h3>
                                    ...
                                    <p className="review-user-user">
                                        xXgamerXx - 20/12/2020
                                    </p>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide className="img-swiper-slide">
                                <div className="rating-box">
                                    ...
                                    <p className="review-user-text">
                                        Bedrock pior q Java. A versão Java suporta uma ampla variedade de mods e plugins, proporcionando aos jogadores a capacidade de modificar significativamente o jogo.
                                    </p>
                                    <p className="review-user-user">
                                        adsasd69 - 26/12/2021
                                    </p>
                            ...
                            <SwiperSlide className="img-swiper-slide">
                                <div className="rating-box">
                                    ...
                                    <p className="review-user-user">
                                        robloxEnjoyer - 20/10/2020
                                    </p>
                                </div>
                            </SwiperSlide>
                            <div className="rating-btns">
                                <img className="rating-img" src="/pen.svg" />
                                <p className="rating-img-text">
                                    Avalie
                                </p>
